// Íconos SVG inline, estilo trazo fino (lucide-like). Sin dependencias externas.
// Todos aceptan className y size para integrarse con CSS existente.
...
export function IconGamepad({ size = 20, className }) {
  return (
...
export function IconEdit({ size = 14, className }) {
  return (
    <svg width={size} height={size} viewBox="0 0 24 24" className={className} {...base}>
...
export function IconLayoutGrid({ size = 16, className }) {
  return (
    <svg width={size} height={size} viewBox="0 0 24 24" className={className} {...base}>
